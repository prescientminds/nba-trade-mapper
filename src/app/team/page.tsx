...
const team: {
  ...
  },
  {
    ...
    bio: `Nate Gershon grew up in Memphis. Every Sunday his mother sat him down at the kitchen table and went through the household expenses \u2014 what they spent, what they got, whether it was worth it. They were on a tight budget. He learned to think about value before he learned to think about basketball.\n\nHe was working at a player agency in New York when the salary cap jumped from $70 million to $94 million in the summer of 2016. Every team in the league had $24 million in unexpected space. Memphis gave Chandler Parsons $22 million a year. Parsons played 95 games over three seasons. Gershon read Article VII of the Collective Bargaining Agreement \u2014 the section that governs the salary cap, maximum salaries, and every exception \u2014 and understood that the contract wasn\u2019t a mistake. It was what the rules produced. He read the rest of the CBA that fall. The agents at the firm wanted to know which exceptions applied and how much cap room their clients had. They did not want to know why. He left the following spring.\n\nHe tracks win shares per dollar spent. He does not evaluate talent. He evaluates outcomes at a given cap percentage, and he has identified what the staff calls the Gershon Threshold \u2014 the cap percentage above which a contract will almost never rank as efficient, no matter how good the player is. Max players are necessary. They are also, by his metric, the worst values in the league. He considers this the most important finding on the site.\n\nHe has a framed printout of Article VII, Section 6 on his wall \u2014 the section governing traded player exceptions. Nobody has asked him about it. He is waiting.`,
