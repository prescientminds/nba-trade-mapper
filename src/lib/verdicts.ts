...
const STRONG = [ // ≥40
  ...
  'CAREER-DEFINING MOVE FOR THE {W}',
  'THE {W} HAD ALL THE LEVERAGE',
  'THE {W} HELD ALL THE CARDS',
  'ONE TEAM GOT A FRANCHISE PLAYER',
  'THE {W} CAUGHT THEM SLEEPING',
  'THE {W} WALKED OUT WITH THE KEYS',
  'THE {W} CASHED IN',
