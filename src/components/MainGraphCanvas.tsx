          ...
          <>
            ...
            {hasUnexpandedPlayers && (
              <ToolbarButton
                ...
                title="Expand roster journeys for all players"
                onClick={async () => {
            ...
            {hasRoadPhasePlayers && (
              <ToolbarButton
                icon={<IconExpand />}
                label={isMobile ? undefined : "After"}
                title="Show where players went after this season"
                onClick={async () => {
                  setChampExpanding(true);
...
// ── Main graph canvas ─────────────────────────────────────────────────
export default function MainGraphCanvas() {
  const nodes = useGraphStore((s) => s.nodes);
